...
export const MobileNavBar = () => {
    ...
    return (
        <div className="md:hidden fixed bottom-0 left-0 right-0 h-16 bg-black/80 backdrop-blur-xl border-t border-white/10 flex items-center justify-around px-2 z-50 pb-safe">
            {navItems.map((item) => {
                ...
                return (
                    <button
                        ...
                        className={cn(
                            "flex flex-col items-center justify-center gap-1 w-full h-full text-zinc-500 hover:text-zinc-300 transition-colors active:scale-95",
